  ...
  return (
    <section id="lessons" className="max-w-7xl mx-auto px-5 sm:px-8 py-24">
      <div className="max-w-2xl mb-14">
        <p className="font-mono text-gold text-xs tracking-[0.25em] uppercase mb-3" data-i18n="lessons.eyebrow">Choose your language</p>
