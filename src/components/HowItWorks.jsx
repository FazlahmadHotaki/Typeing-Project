  ...
  return (
    <section id="how" className="max-w-7xl mx-auto px-5 sm:px-8 py-24">
      ...
      <div className="grid md:grid-cols-4 gap-5">
        ...
        <div className="rounded-2xl bg-night3 border border-white/5 p-6 hover:border-gold/40 transition">
          <div className="flex gap-1.5 mb-5"><span className="keycap h-8 w-8 text-xs">Q</span><span className="keycap h-8 w-8 text-xs">W</span><span className="keycap h-8 w-8 text-xs">E</span><span className="keycap h-8 w-8 text-xs">R</span></div>
        ...
        <div className="rounded-2xl bg-night3 border border-white/5 p-6 hover:border-gold/40 transition">
          <div className="flex gap-1.5 mb-5"><span className="keycap h-8 w-8 text-xs">Z</span><span className="keycap h-8 w-8 text-xs">X</span><span className="keycap h-8 w-8 text-xs">C</span><span className="keycap h-8 w-8 text-xs">V</span></div>
        ...
        <div className="rounded-2xl bg-night3 border border-white/5 p-6 hover:border-gold/40 transition">
          <div className="flex gap-1.5 mb-5"><span className="keycap h-8 w-8 text-xs">1</span><span className="keycap h-8 w-8 text-xs">2</span><span className="keycap h-8 w-8 text-xs">#</span><span className="keycap h-8 w-8 text-xs">@</span></div>
